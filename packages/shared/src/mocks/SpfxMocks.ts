...
export function initializeSpfxMocks(): void {
  ...
  MockBaseClientSideWebPart.prototype = {
    ...
    render: function () {},
    getPropertyPaneConfiguration: function () {
      return { pages: [] };
    },
  ...
  amdModules['@fluentui/react'] = {
    initializeIcons: () => {},
    Stack: (props: any) =>
      window.React.createElement('div', { className: 'ms-Stack' }, props.children),
    ...
    DefaultButton: (props: any) =>
      window.React.createElement('button', props, props.text || props.children),
    PrimaryButton: (props: any) =>
      window.React.createElement(
        'button',
        { ...props, style: { background: '#0078d4', color: 'white' } },
