/** Localized strings used by the shared property pane. */
...
/** Localized strings used by Dynamic Data sources and fields. */
...
/** Default English property pane strings for standalone browser hosts. */
...
/** Default English Dynamic Data strings for standalone browser hosts. */
...
/** Resolve property pane strings for the current browser host. */
export function getPropertyPaneStrings(
  strings?: Partial<IPropertyPaneStrings>,
): IPropertyPaneStrings {
  return {
...
/** Resolve Dynamic Data strings for the current browser host. */
export function getDynamicDataStrings(strings?: Partial<IDynamicDataStrings>): IDynamicDataStrings {
  return {
